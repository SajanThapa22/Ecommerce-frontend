...
const NavbarSmall = ({ navLinks }: Props) => {
  ...
  return (
    <>
      <nav className="w-full bg-white/10 backdrop-blur-md px-[30px] py-2 text-foundation-gray-g-200 flex items-center justify-between border-b border-gray-100 shadow-sm">
